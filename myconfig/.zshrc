...
plugins=(zsh-autosuggestions zsh-syntax-highlighting sudo)
...
export GPG_TTY=$(tty)
alias proot-list='ls $PREFIX/var/lib/proot-distro/installed-rootfs'
alias nv='nvim'
alias lg='lazygit'
...
figlet Mahmud\'s |lolcat --force
figlet Shell | lolcat --force
